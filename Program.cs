...
using Chow_Patty_HW4.DAL;
using Chow_Patty_HW4.Models;
...
String connectionString = "Server=tcp:fa22chowpattyhw4.database.windows.net,1433;Initial Catalog=fa22chowpattyhw4;Persist Security Info=False;User ID=pattychow;Password=Petronilo88!;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
